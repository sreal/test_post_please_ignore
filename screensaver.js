...
// Annotation section
var ScreenSaverComponent = (function () {
    function ScreenSaverComponent() {
        this.summary = new models_1.ExperimentSummary("slideshow", "display progressive images from web source in full screen");
    }
    ScreenSaverComponent = __decorate([
...
exports.ScreenSaverComponent = ScreenSaverComponent;
