...
// Annotation section
var TestbedComponent = (function () {
    function TestbedComponent() {
        this.summary = new models_1.ExperimentSummary("testbed", "experimentation with the basic features and changes in angularjs two compared to one");
        this.content = "transclude is `ng-content`.  shazam!!!";
    }
    TestbedComponent = __decorate([
        angular2_1.Component({ selector: 'testbed' }),
        angular2_1.View({
